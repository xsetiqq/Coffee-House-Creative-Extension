          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div className="flex flex-col gap-4">
                <div className="p-4 bg-background rounded-lg flex items-start  justify-between">
                  <div className="flex gap-4">
                    <div className="w-12 h-12 rounded-lg bg-primary/5 flex items-center justify-center border border-ring">
                  ...
                  <div className="border-ring h-full flex items-center p-2">
                    <ModeToggle />
                  </div>
                </div>
